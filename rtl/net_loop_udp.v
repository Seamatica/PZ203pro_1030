...
//  Define the payload size in bits.
parameter  PAYLOAD_BITS = 112; 
...
//        if (trigger_cnt >= 27'd12_500_000 - 1) begin // Approx every 500ms at 125MHz
...
//wire [31:0] word_msb_first [0:3];
//assign word_msb_first[0] = payload[111 -: 32];
//assign word_msb_first[1] = payload[79 -: 32];
//assign word_msb_first[2] = payload[47 -: 32];
//assign word_msb_first[3] = {payload[15 : 0], 16'b0};
